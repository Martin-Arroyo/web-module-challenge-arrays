...
//RETURNS A FLAVOR TO A GIVEN INDEX
// function getFlavorByIndex(arr, index, flavor){
//     arr.splice(index, 1, flavor,);
//     console.log(arr);
// }
// getFlavorByIndex(originalFlavors, 2, 'Rainbow Sherbert')
...
//     for(let i = 0; i < arr.length; i++){
//         if (arr[i].includes(string)){
//            onlyFlavors.push(arr[i]);
//            console.log(onlyFlavors);
